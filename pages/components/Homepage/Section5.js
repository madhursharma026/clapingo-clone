                ...
                <div className="row">
                    <div className="col-xxl-4 my-3">
                        <div class={styles.imgContainer}>
                            <img src="https://clapingo.com/_next/static/media/feedback-left.b4113833.svg" alt="ImgNotFound" style={{width: '100%'}} />
                    ...
                    <div className="col-xxl-4 my-3">
                        <div class={styles.imgContainer}>
                            <img src="https://clapingo.com/_next/static/media/feedback-center.db4f675d.svg" alt="#ImgNotFound" style={{width: '100%'}} />
                            <div class={styles.imgText}>
                    ...
                    <div className="col-xxl-4 my-3">
                        <div class={styles.imgContainer}>
                            <img src="https://clapingo.com/_next/static/media/feedback-right.dae40e86.svg" alt="#ImgNotFound" style={{width: '100%'}} />
                            <div class={styles.imgText}>
                                <h5>kirti, Delhi</h5>
