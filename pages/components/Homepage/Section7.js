        ...
        <div className={styles.section7Container}>
            <div className="py-5">
                ...
                <div className='p-4 mt-3' style={{ background: '#E5E5E5', borderRadius: '20px' }}>
                    <h4><span style={{ background: '#2EB5A1', borderRadius: '100%', color: 'white', fontSize: '20px', marginRight: '20px' }} className='py-2 px-3'>1</span>What is Clapingo?</h4>
                    <p className='px-5 py-3' style={{ fontSize: '18px' }}><b>Clapingo</b> is a unique platform where you practice conversations live with various tutors across the country. This is a judgment-free space where people can freely speak with a diverse set of people from different backgrounds</p>
                    <h5 className='px-5'>Why Clapingo?</h5>
                    <ul style={{ paddingLeft: '70px' }}>
                        <li>You get one-on-one tutoring so you have the freedom to ask for whatever help you need.</li>
                        <li>The tutors on Clapingo are excellent communicators, they also help learners identify their weak areas and suggest ways to transform.</li>
                        ...
                        <li>Talk on a different topic in each session using Clapingo's Session Documents.</li>
                    </ul>
                </div>

                <div className='p-4 mt-3' style={{ background: '#E5E5E5', borderRadius: '20px' }}>
                    <h4><span style={{ background: '#2EB5A1', borderRadius: '100%', color: 'white', fontSize: '20px', marginRight: '20px' }} className='py-2 px-3'>2</span>How to book your Clapingo Sessions?</h4>
                </div>
